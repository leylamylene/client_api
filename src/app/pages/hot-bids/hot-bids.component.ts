...
@Component({
  ...
  styleUrl: './hot-bids.component.css',
})
export class HotBidsComponent implements OnInit, AfterViewInit {
  @Input('items')
  items: string[] | any[] = [];
  ...
  mouseEntered(item:any){
    return this.mouseEnteredIn == item;
  }
  onMouseEnter(item:any) {
    this.mouseEnteredIn = item;
  }

  onMouseLeave(item:any) {
    this.mouseEnteredIn = null;
  ...
  setUpSlider() {
    ...
    else this.elementsToShow = this.slideConfig.breakpoints.xl;
